...
public class AppDatabaseDef extends DatabaseFactoryImpl {
	...
	public static final String DATABASE_NAME	= "bookmarksplus";
	...
	public static String[] getInstances() {
		...
		String inst = Platform.getProperty("bookmarksplus.instances");
	...
	public _Database loadDatabase(String databaseName) throws JsonException {
		...
		_Database db = new _Database(DATABASE_NAME, "Bookmarks Plus", DATABASE_VERSION);
